...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "parikhsmit1105@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/smit-parikh-123763268",
    content: "/smit-parikh-123763268",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/224csd3-dot",
    content: "/224csd3-dot",
...
function Page() {
  // Tools are always loaded on render
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Smit Parikh</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Smit, a Fullstack developer passionate about
