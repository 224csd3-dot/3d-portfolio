...
export enum SkillNames {
  ...
  GIT = "git",
  GITHUB = "github",
  WEB_FOUNDATIONS = "web_foundations",
  PRETTIER = "prettier",
  NPM = "npm",
  FIREBASE = "firebase",
  WORDPRESS = "wordpress",
...
using use = useUsing("use")`,
  ...
  [SkillNames.WEB_FOUNDATIONS]: {
    id: 15,
    name: "web-foundations",
    label: "Web Development Fundamentals",
    shortDescription: "solid foundations for reliable, usable websites",
    color: "#e34c26",
    icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original.svg",
  },
  [SkillNames.PRETTIER]: {
...
export const EXPERIENCE: Experience[] = [
  {
    ...
    description: [
      "Designed and developed modern, responsive websites for businesses across restaurant, education, and fitness domains.",
      "Built complete web solutions from UI design to deployment, focusing on performance and clean user experience.",
      "Translated business requirements into production-ready websites with real users and live traffic.",
      "Worked with modern frontend and backend tools to deliver scalable and maintainable codebases.",
      "Deployed and maintained websites with live domains, ensuring reliability and usability.",
    ],
    skills: [
      SkillNames.HTML,
      SkillNames.CSS,
  ...
  },
  {
    ...
    startDate: "2021",
    endDate: "Present",
    title: "Computer Science Student (Third Year)",
    company: "Academic & Practical Development",
    description: [
      "Pursuing Computer Science while actively building real-world web projects alongside academics.",
      "Applied full-stack concepts through hands-on development of business websites and client-style projects.",
      "Focused on writing clean, readable, and maintainable code following modern development practices.",
      "Continuously improving skills in web technologies, UI/UX principles, and project structuring.",
    ],
    skills: [
      SkillNames.JS,
      SkillNames.REACT,
